...
- (void)loadView
{
    ...
    _container.backgroundColor			=[UIColor colorWithPatternImage:[UIImage imageNamed:@"detail_background.png"]];
    ...
    // setup thumbs view
    _thumbsView.backgroundColor					= [UIColor colorWithPatternImage:[UIImage imageNamed:@"detail_background.png"]];
	...
	UIImage *leftIcon = [UIImage imageNamed:@"navigation-back"];
	UIImage *rightIcon = [UIImage imageNamed:@"navigation-right"];
...
- (void)setUseThumbnailView:(BOOL)useThumbnailView
{
    ...
    if( self.navigationController ) {
        if (_useThumbnailView) {
            ...
            // Buttons prev
            UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
            [button setBackgroundImage:[UIImage imageNamed:@"button-mosaique"] forState:UIControlStateNormal];
            [button setTitle:@"" forState:UIControlStateNormal];
            button.frame=CGRectMake(0.0, 0, 20, 15);
            [button addTarget:self action:@selector(handleSeeAllTouch:) forControlEvents:UIControlEventTouchUpInside];
            UIBarButtonItem* deleteItem = [[UIBarButtonItem alloc] initWithCustomView:button];
            self.navigationItem.rightBarButtonItem = deleteItem;
            /*
             
             UIBarButtonItem *btn = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"button-mosaique"] style:UIControlStateNormal target:self action:@selector(handleSeeAllTouch:)];
